      ...
      <header className="header">
        <div className="container">
          ...
          <div className="auth-buttons">
            <button className="btn-primary-login" onClick={() => navigate('/signup')}>Sign Up</button>
            <button className="btn-primary-login" onClick={() => navigate('/login')}>Login</button>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <button className="btn-primary-login" onClick={() => navigate('/signup')}>
                 Get Started
              </button>
          ...
          <div className="trades-grid">
            <div className="trade-card creative">
              ...
              <div className="trade-thumbnails">
                ...
                <div className="thumb-item">
                  <img src="src/assets/images/img-1.jpg" alt="UI/UX" />
                </div>
            ...
            <div className="trade-card knowledge">
              ...
              <div className="trade-thumbnails">
                ...
                <div className="thumb-item">
                  <img src="src/assets/images/img-17.jpg" alt="UI/UX" />
                </div>
            ...
            <div className="trade-card digital">
              ...
              <div className="trade-thumbnails">
                ...
                <div className="thumb-item">
                  <img src="src/assets/images/img-18.jpg" alt="UI/UX" />
                </div>
