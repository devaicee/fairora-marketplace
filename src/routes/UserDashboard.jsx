...
const UserDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Mock trending trades (would come from trades collection)
      setTrendingTrades([
        {
          id: 1,
      ...
      // Mock top creators (would be calculated from trades)
      setTopCreators([
      ...
      // Try to load forum topics from Firestore, fallback to mock data
      try {
        ...
        console.log('Forums collection not found, using mock data');
          ...
          <div className="sidebar-content">
            <div className="user-profile-section">
              <div className="user-avatar">
                <img src="src/assets/icons/ava-1.png" alt={user?.email} />
              </div>
              <div className="user-info">
                <h4>{userProfile?.email || user?.email}</h4>
